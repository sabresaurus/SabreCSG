...
namespace Sabresaurus.SabreCSG.ShapeEditor.Triangulator
{
	...
	public static class Triangulator
    {
            ...
            out int[] indices)
        {
            ...
            // Henry: I commented out all of this code as per https://github.com/nickgravelyn/Triangulator/issues/1
        ...
        public static Vector2[] CutHoleInShape(Vector2[] shapeVerts, Vector2[] holeVerts)
        {
            ...
            {
                float? intersection = segment.IntersectsWithRay(rightMostHoleVertex.Position, Vector2.right/*.UnitX*/);
            ...
            Vector2 I = rightMostHoleVertex.Position + Vector2.right/*.UnitX*/ * closestPoint.Value;
            ...
            if (interiorReflexVertices.Count > 0)
            {
                ...
                foreach (Vertex v in interiorReflexVertices)
                {
                    ...
                    float dot = Vector2.Dot(Vector2.right/*.UnitX*/, d);
