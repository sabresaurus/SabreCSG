...
//			polygon.CalculatePlane();
        ...
        public static bool PlanePlaneIntersection(out Vector3 linePoint, out Vector3 lineVec, Plane plane1, Plane plane2){
            ...
            Vector3 plane1Position = new Vector3(plane1.distance, 0f, 0f);
            Vector3 plane2Position = new Vector3(plane2.distance, 0f, 0f);
        ...
        public static bool LinePlaneIntersection(out Vector3 intersection, Vector3 linePoint, Vector3 lineVec, Plane plane){
            ...
            Vector3 planePoint = new Vector3(plane.distance, 0f, 0f);
        ...
        internal static Vector3 SetVectorLength(Vector3 vector, float size){
