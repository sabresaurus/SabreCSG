...
namespace Sabresaurus.SabreCSG
{
    public static class Extensions
    {
        ...
        /// <para>
        /// The <see cref="Stack{T}"/> class is not serialized by Unity but <see cref="List{T}"/> is.
        /// These methods are useful to simulate the behaviour of <see cref="Stack{T}"/> with regular
        /// <see cref="List{T}"/>'s that get serialized.
        /// </para>
        /// </summary>
