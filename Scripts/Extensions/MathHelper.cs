...
namespace Sabresaurus.SabreCSG
{
	public static class MathHelper
	{
        ...
        /// </summary>
        public const float EPSILON_3_3 = 1e-3f;
        ...
        {
            if (
                Mathf.Abs(plane1.distance - plane2.distance) < EPSILON_3_3
                && Mathf.Abs(plane1.normal.x - plane2.normal.x) < EPSILON_3
                && Mathf.Abs(plane1.normal.y - plane2.normal.y) < EPSILON_3
                && Mathf.Abs(plane1.normal.z - plane2.normal.z) < EPSILON_3)
            {
                return true;
            }
            else if (
